%% GABARIT POUR THÈSE EN EXTENSION À L'UNIVERSITÉ DE SHERBROOKE
%%
...
\documentclass[PhD,extensionUdeS,english,french]{ulthese}
 ...
 \bibliographystyle{}
  ...
  \auteur{<Prénom Nom>}
  \annee{<20xx>}
  \programme{Doctorat en <discipline>}
  ...
  \faculteUL{<Nom de la faculté UL>}
  \faculteUdeS{<Nom de la faculté UdeS>}
